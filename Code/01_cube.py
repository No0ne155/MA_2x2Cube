    ...
    def move(self):
        ...
        if move == 'd':
            if self.pos[0] == [150,290]:
                ...
                self.pos[1] = [200,290]
                self.pos[2][0] = self.pos[2][0] + 100
                self.pos[0][0] = self.pos[0][0] + 100
            elif self.pos[2] == [150,290]:
                self.pos[2] = [200,290]
                self.pos[0][0] = self.pos[0][0] + 100
                self.pos[1][0] = self.pos[1][0] + 100
                ...
                self.pos[1] = [150,340]
                self.pos[2][0] = self.pos[2][0] - 300
                self.pos[0][0] = self.pos[0][0] + 100
            elif self.pos[2] == [200,340]:
                self.pos[2] = [150,340]
                self.pos[0][0] = self.pos[0][0] - 300
                self.pos[1][0] = self.pos[1][0] + 100

    ...
    def move(self):
        if move == 'u':
            if self.pos[0] == [150, 90]:
                self.pos[0] = [200, 90]
            elif self.pos[1] == [400,190]:
                self.pos[1] = [300,190]
            elif self.pos[2] == [50, 190]:
                self.pos[2] = [350,190]
            elif self.pos[0] == [200, 90]:
                self.pos[0] = [200,140]
            elif self.pos[1] == [300,190]:
                self.pos[1] = [200,190]
            elif self.pos[2] == [350,190]:
                self.pos[2] = [250,190]
            elif self.pos[0] == [200,140]:
                self.pos[0] = [150,140]
            elif self.pos[1] == [200,190]:
                self.pos[1] = [100,190]
            elif self.pos[2] == [250,190]:
                self.pos[2] = [150,190]
            elif self.pos[0] == [150,140]:
                self.pos[0] = [150, 90]
            elif self.pos[1] == [100,190]:
                self.pos[1] = [400,190]
